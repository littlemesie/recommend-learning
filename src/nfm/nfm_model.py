...
class NFM(BaseEstimator, TransformerMixin):
    ...
    def __init__(self, feature_size, field_size, embedding_size=8, deep_layers=[32, 32], deep_init_size=50,
                 dropout_deep=[0.5, 0.5, 0.5], deep_layer_activation=tf.nn.relu, epoch=10, batch_size=256,
                 learning_rate=0.001, optimizer="adam", batch_norm=0, batch_norm_decay=0.995, verbose=False,
                 random_seed=2020,loss_type="logloss", eval_metric=roc_auc_score,
    ...
    def fit(self, Xi_train, Xv_train, y_train, Xi_valid=None, Xv_valid=None, y_valid=None,
        ...
        for epoch in range(self.epoch):
            ...
            if has_valid:
                ...
                y_pred = loss = self.predict(Xi_valid, Xv_valid)
